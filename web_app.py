...
with tabs1:
    ...
    with col2:
        # Open a new tab with HTML link and ML model prediction
        if st.button("Open Case 1"):
            # Replace the URL below with your ML model endpoint
            ml_model_url = "https://your-ml-model-endpoint.com"
            st.markdown(f"<a href='{ml_model_url}' target='_blank'>Open Case 1 Prediction</a>", unsafe_allow_html=True)
